        ...
        protected void Conectar()
        {
            try
            {
                ...
                //{
                    ...
                    Config.Login = txt_login.Text.ToUpper().Trim();//_integra.Login.ToUpper().Trim(); //txt_login.Text.ToUpper().Trim(); //
                    Config.Senha = txt_senha.Text.ToUpper().Trim();//_integra.Senha.ToUpper().Trim(); //txt_senha.Text.ToUpper().Trim(); //
                //}
                //else
                //{
